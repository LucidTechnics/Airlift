   ...
   extends Generator
{
    ...
    /** The Constant AIRLIFT_SQL_FIND_SQLTEMPLATE. */
	...
	/**
	 * Generate find by this range sql.
	 *
	 * @param _domainObjectModel the _domain object model
	 * @param _rangeField the _range field
	 * @return the string
	 */
	...
	/**
	 * Generate find by this attribute sql.
	 *
	 * @param _domainObjectModel the _domain object model
	...
	/**
	 * Generate find by this membership sql.
	 *
	 * @param _domainObjectModel the _domain object model
	 * @param _attribute the _attribute
	 * @return the string
