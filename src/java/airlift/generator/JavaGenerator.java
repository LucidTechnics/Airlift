...
*/
	...
	public String generateDomainObject(DomainObjectModel _domainObjectModel)
	{
		...
		while (attributes.hasNext() == true)
		{
			...
			attributeStringTemplate.setAttribute("scope", scope);
	...
	/**
	 * Generate do domain index object.
	 *
	 * @param _domainObjectModel the _domain object model
	 * @return the string
	 */
