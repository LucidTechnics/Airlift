...
{
	var timezone = (airlift.isDefined(_config.timezone) === true) ? airlift.string(_config.timezone) : (airlift.isDefined(TIMEZONE) === true) ? TIMEZONE.getID() : airlift.string("UTC");
