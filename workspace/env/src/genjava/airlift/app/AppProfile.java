   ...
   implements airlift.AppProfile
{
	...
	static
	{
		...
		resourceSecurityMetadataMap.get("registration").put("COLLECT", new java.util.HashSet<String>()); 
		resourceSecurityMetadataMap.get("registration").put("PUT", new java.util.HashSet<String>()); 
		resourceSecurityMetadataMap.get("registration").put("POST", new java.util.HashSet<String>()); 
		resourceSecurityMetadataMap.get("registration").put("HEAD", new java.util.HashSet<String>()); 
		resourceSecurityMetadataMap.get("registration").put("GET", new java.util.HashSet<String>()); 
		...
		resourceSecurityMetadataMap.get("registration").get("COLLECT").add("person"); 
		resourceSecurityMetadataMap.get("registration").get("PUT").add("person"); 
		resourceSecurityMetadataMap.get("registration").get("POST").add("person"); 
		resourceSecurityMetadataMap.get("registration").get("HEAD").add("person"); 
		resourceSecurityMetadataMap.get("registration").get("GET").add("person"); 
